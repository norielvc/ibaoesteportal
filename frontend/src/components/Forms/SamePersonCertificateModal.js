                                    ...
                                    <div className="space-y-4 md:space-y-6">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pb-6">
                                            ...
                                            <div className="relative group">
                                                ...
                                                <input type="text" name="fullName2" value={formData.fullName2} onChange={handleInputChange} placeholder="SECONDARY NAME / ALIAS / IKALAWANG PANGALAN / ALYAS" className={`w-full px-6 py-5 bg-white border-2 ${errors.fullName2 ? 'border-red-500 bg-red-50' : 'border-gray-100'} rounded-2xl transition-all duration-300 font-bold text-lg focus:border-blue-300 focus:shadow-sm uppercase`} />
                                            </div>
                                        </div>
