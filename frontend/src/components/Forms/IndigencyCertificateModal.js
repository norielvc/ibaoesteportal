                ...
                <div className="flex items-center gap-3 md:gap-5 relative z-10">
                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      ...
                      <p className="text-white text-[10px] md:text-xs font-black uppercase tracking-widest px-4 py-1.5 bg-red-600 rounded-l-full rounded-tr-md rounded-br-md shadow-md">{referenceNumber || 'New Indigency Request'}</p>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-100 pb-4">
                      <div className="flex items-center gap-4 bg-gradient-to-r from-[#8cc63f] to-[#b4d339] rounded-l-full rounded-r-xl p-2 pr-6 shadow-sm mb-6">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-white/90 font-medium tracking-wide">Verify your registered details</p>
                        </div>
                      </div>
