...
export default function IndigencyCertificateModal({ isOpen, onClose, isDemo = false }) {
                ...
                <div className="flex items-center gap-3 relative z-10">
                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="flex items-center gap-2 mt-0.5">
                      ...
                      <p className="text-white text-sm font-bold uppercase tracking-wide px-2 py-0.5 bg-red-600 rounded-md shadow-md">{referenceNumber || 'New Indigency Request'}</p>
                    </div>
                  </div>
                </div>
