                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input type="text" name="fullName" value={formData.fullName} onChange={handleInputChange} placeholder="e.g., JUAN DELA CRUZ"
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 uppercase" />
                  </div>
                  ...
                  <div>
                    ...
                    <input type="text" name="address" value={formData.address} onChange={handleInputChange}
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 uppercase" placeholder="" />
                  </div>
              ...
              <>
                <button type="button" onClick={() => {
                  ...
                  printWindow.document.write(`
                    <!DOCTYPE html><html><head><title>Certificate of Indigency - ${referenceNumber}</title>
                ...
                }} className="px-6 py-2.5 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-lg font-medium flex items-center justify-center gap-2 shadow-lg">
...
// Certificate Preview - A4 Size Layout (same as Barangay Clearance)
        ...
        <div className="flex flex-1 mt-2">
          ...
          <div className={`flex-1 p-6 flex flex-col ${getFontClass(bodyStyle.fontFamily)}`} style={{ backgroundColor: bodyStyle.bgColor }}>
            ...
            <div className="flex-1" style={{ color: bodyStyle.textColor, fontSize: `${bodyStyle.textSize || 14}px` }}>
              ...
              <p className="mb-16 font-semibold">TRULY YOURS,</p>
