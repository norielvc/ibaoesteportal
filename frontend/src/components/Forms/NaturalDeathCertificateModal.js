...
export default function NaturalDeathCertificateModal({ isOpen, onClose, isDemo = false }) {
    ...
    const validateForm = () => {
        const required = ['deceasedFullName', 'dateOfDeath', 'placeOfDeath', 'causeOfDeath', 'requesterFullName', 'relationship', 'contactNumber'];
        const newErrors = {};
    ...
    const SectionHeader = ({ num, title, subtitle }) => (
        <div className="flex items-center gap-3 bg-gradient-to-r from-[#8cc63f] to-[#b4d339] rounded-l-full rounded-r-lg p-1.5 pr-4 shadow-sm mb-4">
            ...
            <div>
                ...
                {subtitle && <p className="text-sm text-white/90 font-medium tracking-wide">{subtitle}</p>}
            </div>
        </div>
    );
                                ...
                                <div className="flex items-center gap-3 relative z-10">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <div className="flex items-center gap-2 mt-0.5">
                                            ...
                                            <p className="text-white text-sm font-bold uppercase tracking-wide px-2 py-0.5 bg-red-600 rounded-md shadow-md">{referenceNumber || 'New Natural Death Request'}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <form onSubmit={handleSubmit} className="p-4 space-y-6">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="relative group">
                                            <label className="text-sm font-bold text-gray-400 uppercase tracking-wide ml-1 mb-1 block">Full Name of Deceased / Buong Pangalan ng Yumaong <span className="text-red-500">*</span></label>
                                            <input
                                        ...
                                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                                            <div>
                                                <label className="text-sm font-bold text-[#2d5a3d] uppercase tracking-wide ml-1 block mb-1">Date of Death / Petsa ng Kamatayan <span className="text-red-500">*</span></label>
                                                <input type="date" name="dateOfDeath" value={formData.dateOfDeath} onChange={handleInputChange} className={inputClass('dateOfDeath')} />
                                            </div>
                                            <div>
                                                <label className="text-sm font-bold text-[#2d5a3d] uppercase tracking-wide ml-1 block mb-1">Place of Death / Lugar ng Kamatayan <span className="text-red-500">*</span></label>
                                            ...
                                            <div>
                                                <label className="text-sm font-bold text-[#2d5a3d] uppercase tracking-wide ml-1 block mb-1">Cause of Death / Dahilan ng Kamatayan <span className="text-red-500">*</span></label>
                                    ...
                                    <div className="pt-4 border-t border-gray-100 space-y-4">
                                        ...
                                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                            <div>
                                                <label className="text-sm font-bold text-[#2d5a3d] uppercase tracking-wide ml-1 block mb-1">Full Name of Requester / Pangalan ng Humihiling <span className="text-red-500">*</span></label>
                                            ...
                                            <div>
                                                <label className="text-sm font-bold text-[#2d5a3d] uppercase tracking-wide ml-1 block mb-1">Relationship to Deceased / Relasyon sa Yumaong <span className="text-red-500">*</span></label>
                                    ...
                                    <div className="pt-4 border-t border-gray-100 space-y-4">
                                        <SectionHeader num="3" title="Contact Details / Detalye ng Contact" subtitle="Notification details / Detalye ng notification" />
                                    ...
                                    <div className="pt-4 border-t border-gray-100">
                                        <SectionHeader num="4" title="Application Intent / Layunin ng Aplikasyon" subtitle="Purpose of your request / Dahilan ng inyong pagkuha" />
                                        <div className="space-y-4">
                                            <div className="space-y-1">
                                                ...
                                                <textarea 
                                                    ...
                                                    rows={4} 
                                                    placeholder="e.g. For death benefits application, legal requirements..." 
                                ...
                                <div className="bg-[#112e1f]/5 border border-[#112e1f]/10 rounded-lg p-4 text-left mb-4">
                                    ...
                                    <div className="space-y-3">
                                        <div className="flex items-start gap-3">
                                            ...
                                            <p className="text-sm text-gray-600 font-bold leading-relaxed">Processing typically takes 1-3 business days. Your application is now in queue for chairman approval.</p>
                                        </div>
                                        <div className="flex items-start gap-3">
