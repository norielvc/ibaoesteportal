...
export default function CohabitationCertificateModal({ isOpen, onClose, isDemo = false }) {
    ...
    const ResidentBlock = ({ nameKey, label, btnLabel, person }) => (
        <div className="space-y-3">
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3 border-b border-gray-100 pb-3">
                <div className="flex items-center gap-3 bg-gradient-to-r from-[#8cc63f] to-[#b4d339] rounded-l-full rounded-r-lg p-1.5 pr-4 shadow-sm">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-white/90 font-medium tracking-wide">Select from resident directory</p>
                    </div>
                </div>
                <button
                    type="button"
            ...
            <div className="relative">
                <label className="text-sm font-bold text-gray-400 uppercase tracking-wide ml-1 mb-1 block">Full Name / Buong Pangalan <span className="text-red-500">*</span></label>
                <input
                    type="text"
                    name={nameKey}
                                ...
                                <div className="flex items-center gap-3 relative z-10">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <div className="flex items-center gap-2 mt-0.5">
                                            ...
                                            <p className="text-white text-sm font-bold uppercase tracking-wide px-2 py-0.5 bg-red-600 rounded-md shadow-md">{referenceNumber || 'New Cohabitation Request'}</p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="pt-4 border-t border-gray-100 space-y-4">
                                        <div className="flex items-center gap-3 bg-gradient-to-r from-[#8cc63f] to-[#b4d339] rounded-l-full rounded-r-lg p-1.5 pr-4 shadow-sm mb-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-white/90 font-medium tracking-wide">Common address and duration of living together</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                                            ...
                                            <div className="space-y-1">
                                                <label className="text-sm font-bold text-[#2d5a3d] uppercase tracking-wide ml-1 block">Years Together / Taon na Magkasama</label>
                                            ...
                                            <div className="space-y-1">
                                                <label className="text-sm font-bold text-[#2d5a3d] uppercase tracking-wide ml-1 block">Months Together / Buwan na Magkasama</label>
                                    ...
                                    <div className="pt-4 border-t border-gray-100 space-y-4">
                                        <div className="flex items-center gap-3 bg-gradient-to-r from-[#8cc63f] to-[#b4d339] rounded-l-full rounded-r-lg p-1.5 pr-4 shadow-sm mb-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-white/90 font-medium tracking-wide">Where to receive updates / Saan tatanggap ng mga update</p>
                                            </div>
                                        </div>
