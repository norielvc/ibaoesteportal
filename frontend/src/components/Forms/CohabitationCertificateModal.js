...
export default function CohabitationCertificateModal({ isOpen, onClose, isDemo = false, tenantConfig = {} }) {
  ...
  // Address fields — entered by requestor, NOT pre-filled from DB
    ...
    <div className="space-y-5">
      ...
      <div>
        ...
        <textarea
          ...
          onChange={e => setCurrentAddress(e.target.value.toUpperCase())}
        ...
        <p className="text-[10px] text-gray-400 mt-1 ml-1">
          ⚠️ Do not include sensitive details like landmarks. Barangay name and municipality is sufficient. /
          Huwag isama ang mga sensitibong detalye. Sapat na ang pangalan ng barangay at munisipyo.
        </p>
      </div>
      ...
      <div className="flex items-center gap-3 p-4 bg-gray-50 border border-gray-200 rounded-2xl">
        ...
        <p className="text-[11px] text-gray-500 font-semibold">
          Staff will review this address against both residents' records on file and may update them if a change is confirmed.
          <br />
