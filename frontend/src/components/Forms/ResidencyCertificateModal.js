            ...
            {!showPreview ? (
              <form onSubmit={handleSubmit} className="p-6 space-y-6">
                <div className="bg-gradient-to-r from-orange-50 to-amber-50 border border-orange-200 rounded-xl p-4">
                  <div className="flex items-start gap-3">
                    <div className="bg-orange-100 p-2 rounded-lg shrink-0"><Info className="w-5 h-5 text-orange-600" /></div>
                    <div className="space-y-1">
                      <p className="text-xs font-black text-orange-700 uppercase tracking-widest">Public Notice</p>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1 flex justify-between items-center">
                      ...
                      <button
                        ...
                        className="text-orange-600 hover:text-orange-700 text-xs font-semibold flex items-center gap-1 bg-orange-50 px-2 py-1 rounded-md transition-colors"
                      >
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 uppercase pr-10 cursor-pointer bg-gray-50 hover:bg-white transition-colors font-bold text-orange-700"
                      />
                      <Search
                        className="absolute right-3 top-1/2 -translate-y-1/2 text-orange-600 w-5 h-5 cursor-pointer"
                        onClick={() => setIsResidentModalOpen(true)}
                      />
                    </div>
                  </div>
            ...
            <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-5xl max-h-[95vh] flex flex-col overflow-hidden">
              ...
              <div className="border-t bg-white px-6 py-4 flex flex-col sm:flex-row gap-3 justify-end pb-10 sm:pb-4">
                ...
                <button
                  ...
                  disabled={isSubmitting}
                  className="px-6 py-2.5 bg-gradient-to-r from-orange-600 to-orange-700 hover:from-orange-700 hover:to-orange-800 text-white rounded-lg font-medium flex items-center justify-center gap-2 shadow-lg disabled:opacity-75 disabled:cursor-not-allowed">
                  {isSubmitting ? (
                    <>
