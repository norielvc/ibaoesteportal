                  ...
                  <div className="flex items-start gap-4 relative z-10">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-emerald-800/90 leading-relaxed text-sm">
                        ...
                        New residents are requested to visit the <span className="font-bold underline decoration-emerald-300/50">Barangay Hall</span> for initial manual registration.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="pt-6 border-t border-gray-100">
                    ...
                    <div className="space-y-2 relative">
                      ...
                      <textarea
                        ...
                        rows={3}
                        placeholder="e.g. School Enrollment, Employment Requirement, ID Application, Proof of Address..."
                  ...
                  <div className="bg-[#112e1f]/5 border border-[#112e1f]/10 rounded-2xl p-5 relative overflow-hidden">
                    ...
                    <ul className="text-xs text-gray-600 space-y-3 font-medium">
                      <li className="flex items-start gap-3">
                        ...
                        <span>Our team will verify your primary residence using current census data.</span>
                      </li>
                      <li className="flex items-start gap-3">
