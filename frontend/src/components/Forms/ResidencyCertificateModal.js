                  ...
                  <div className="bg-gradient-to-br from-emerald-50 to-teal-50 border border-emerald-100 rounded-2xl p-6 shadow-sm relative overflow-hidden group">
                    <div className="flex items-start gap-4 relative z-10">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-emerald-800/90 leading-relaxed text-sm">Online residency certificates are for registered residents. You will receive an email update once processed.</p>
                      </div>
                    </div>
                  </div>
